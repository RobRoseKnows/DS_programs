/* Print Spiral level order of tree */
...
void print_level(bst_node *root, int level, int toggle)
{
        if (level == 1) {
                printf("%d ", root->key);
        } else if (level > 1) {
                if (toggle) {
                        if (root->left)
                                print_level(root->left, level - 1, toggle);
                        if (root->right)
                                print_level(root->right, level - 1, toggle);
                } else {
                        if (root->right)
                                print_level(root->right, level - 1, toggle);
                        if (root->left)
